...
# Because Time is used forst in the tree, it is the single most important predictor of DR
# Nodes indicated by * are terminal or leaf nodes
# They mean thaat ehy result in a prediction (yval)
...
# Type and extra parameters affect the ay the decions and nodes are labelled
# numbr 3 and 101 refer to a style format
# fallen.leaves forces rhe leaf nodes to be aligned at the bottom of the plot
...
# less corrleation than regression tree -> preditions are related to the true value in a weaker manner 
